    ...
    <div className = "hero">
      <div className = "space-y-2 items-center text-center">
        ...
        <div className="input input-bordered flex items-center gap-2 w-full max-w-[40ch]">
          ...
          <input type="text" className="grow text-slate-900" placeholder="Email" value={email} 
          onChange = {(e) => setEmail(e.target.value)}/>
        </div>

        <div className="input input-bordered flex items-center gap-2 w-full max-w-[40ch]">
          <i className="fa-solid fa-key"/>
          <input type="password" className="grow text-slate-900" placeholder='Password' value={password} 
